                    ...
                    <div className="space-y-6">
                        <div className="p-6 rounded-2xl bg-gradient-to-br from-neutral-900/50 to-neutral-800/50 border border-neutral-700/50 backdrop-blur-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <a href={`${import.meta.env.BASE_URL}Harish_Panneer_Selvam__Resume_2025.pdf`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:bg-neutral-800/50 p-2 rounded-lg transition-colors">
